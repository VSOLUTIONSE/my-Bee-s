      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <a href={cv} download className="inline-block bg-gray-900 text-white px-8 py-4 rounded-full font-bold hover:bg-brand hover:text-black hover:shadow-[0_10px_20px_-10px_rgba(74,246,38,0.6)] hover:-translate-y-1 transition-all duration-300">
                Download CV
            </a>
          </div>
        </div>
